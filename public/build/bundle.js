...
var app = (function () {
    ...
    // (25:1) {#each selectionValues as option}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file, 25, 2, 424);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*selectionValues*/ 2 && t0_value !== (t0_value = /*option*/ ctx[3].text + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*selectionValues*/ 2 && option_value_value !== (option_value_value = /*option*/ ctx[3].value)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(25:1) {#each selectionValues as option}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(select, "selected", /*selected*/ ctx[0]);
    			attr_dev(select, "class", "svelte-e5kcei");
    			if (/*selected*/ ctx[0] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[2].call(select));
    			add_location(select, file, 23, 0, 336);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { selected } = $$props;
    	const writable_props = ["selectionValues", "selected"];
    	...
    	$$self.$capture_state = () => ({ selectionValues, selected });
    	...
    	return [selected, selectionValues, select_change_handler];
    }

    class Select extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { selectionValues: 1, selected: 0 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 94, 0, 1880);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    	function drawChart() {
    		...
    		gemeentes.transition().duration(500).attr("opacity", d => opacityScale(gestolenPerGemeente[d.properties.statnaam][scaleVar]));
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$5, 82, 0, 1852);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    	function drawChart() {
    		...
    		const pointOuter = point.append("circle").attr("r", radius).attr("cx", d => xScale(d.x)).attr("cy", d => yScale(d.y)).style("fill", d => decideColor(d));
    	}
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t = text("Data komt ergens vandaan wat ik je lekker niet ga vertellen lol");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "Onderstaand overzicht laat zien hoe auto’s gestolen worden en wat je eraan kan doen.";
    			t3 = space();
    			create_component(info.$$.fragment);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$7, 65, 2, 2264);
    			attr_dev(a, "href", "https://github.com/SjorsWijsman/frontend-data");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$7, 66, 2, 2300);
    			add_location(section, file$7, 64, 1, 2252);
    			add_location(footer, file$7, 63, 0, 2242);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
