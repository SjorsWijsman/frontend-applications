    ...
    class Select extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*selectionValues*/ ctx[1] === undefined && !("selectionValues" in props)) {
    			console_1.warn("<Select> was created without expected prop 'selectionValues'");
    		}

    		if (/*selected*/ ctx[0] === undefined && !("selected" in props)) {
    			console_1.warn("<Select> was created without expected prop 'selected'");
    		}

    		if (/*storageKey*/ ctx[2] === undefined && !("storageKey" in props)) {
    			console_1.warn("<Select> was created without expected prop 'storageKey'");
    		}
    	}
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$2, 238, 0, 6355);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
