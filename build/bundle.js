...
var app = (function () {
    ...
    */
    ...
    const autoInbraak = [{
      ...
      },
      {
        ...
        type: "advice",
        title: "Spullen",
        text: "Neem al je waardevolle spullen mee uit de auto en zorg ervoor dat alle achtergebleven elektronica uitgeschakeld is."
      },
      {
        x: 62,
        y: 48,
        type: "advice",
        title: "Afsluiten",
        text: "Sluit je auto altijd goed af en check de ramen, deuren (en eventueel het dak) goed dicht zitten."
      },
      {
        x: 30,
        y: 88,
      ...
      },
      {
        ...
        y: 40,
        type: "attack",
        title: "Steutelloze Autodiefstal",
        text: "Dieven werken samen om het signaal vanuit huis van uw smart key te onderscheppen en versterkt door te sturen om de auto te openen."
      }
    ];
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$5, 91, 0, 1979);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    	function drawChart() {
    		...
    		const point = car.selectAll(".point").data(autoInbraak).enter().append("g").attr("class", "point").on("mousemove", (e, d) => {
    			tooltip.setText(tooltipText(d));
    			tooltip.showTooltip(e);
    ...
    function create_default_slot_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$7, 36, 2, 1297);
    			add_location(p1, file$7, 40, 2, 1454);
    		},
    		m: function mount(target, anchor) {
    ...
    // (48:1) <MapChart tooltip={tooltip} selectionValues={mapChartSelectionValues}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(48:1) <MapChart tooltip={tooltip} selectionValues={mapChartSelectionValues}>",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t = text("Informatie van zelfverzekerd.nl en consumentenbond.nl.");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    ...
    // (61:1) <GraphicChart tooltip={tooltip}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			create_component(info.$$.fragment);
    			add_location(h2, file$7, 61, 2, 2450);
    			set_style(span0, "color", "var(--error-color)");
    			add_location(span0, file$7, 63, 63, 2556);
    			set_style(span1, "color", "var(--succes-color)");
    			add_location(span1, file$7, 64, 29, 2634);
    			add_location(p, file$7, 62, 2, 2489);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    			insert_dev(target, t1, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(61:1) <GraphicChart tooltip={tooltip}>",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$7, 74, 2, 2882);
    			attr_dev(a, "href", "https://github.com/SjorsWijsman/frontend-applications");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$7, 75, 2, 2918);
    			add_location(section, file$7, 73, 1, 2870);
    			add_location(footer, file$7, 72, 0, 2860);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
