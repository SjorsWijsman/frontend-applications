...
var app = (function () {
    ...
    */
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t = text("Data van zelfverzekerd.nl en consumentenbond.nl");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$7, 71, 2, 2671);
    			attr_dev(a, "href", "https://github.com/SjorsWijsman/frontend-applications");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$7, 72, 2, 2707);
    			add_location(section, file$7, 70, 1, 2659);
    			add_location(footer, file$7, 69, 0, 2649);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
